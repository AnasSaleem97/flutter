...
extension LocalProfileQuerySortBy
  ...
  QueryBuilder<LocalProfile, LocalProfile, QAfterSortBy> sortByIsDirty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDirty', Sort.asc);
    });
  }

  QueryBuilder<LocalProfile, LocalProfile, QAfterSortBy> sortByIsDirtyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalProfileQuerySortThenBy
  ...
  QueryBuilder<LocalProfile, LocalProfile, QAfterSortBy> thenByIsDirty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDirty', Sort.asc);
    });
  }

  QueryBuilder<LocalProfile, LocalProfile, QAfterSortBy> thenByIsDirtyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDirty', Sort.desc);
    });
  }
...
extension LocalProfileQueryWhereDistinct
  ...
  QueryBuilder<LocalProfile, LocalProfile, QDistinct> distinctByAvatarLocalPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalProfile, LocalProfile, QDistinct> distinctByIsDirty() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalProfileQueryProperty
  ...
  QueryBuilder<LocalProfile, bool, QQueryOperations> isDirtyProperty() {
    return QueryBuilder.apply(this, (query) {
